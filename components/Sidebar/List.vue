<template v-if="tabSidebar === 'default'">
  ...
  <div class="flex flex-col w-full h-full">
    <client-only>
      <div :key="keyList" class="flex justify-center items-center w-full h-full px-10">
      ...
      <div :key="keyList" class="flex justify-center items-center py-6 bg-white w-full mt-auto">
